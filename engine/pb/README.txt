...
(3) In the root directory of this project, enter "protoc -I ./api/pb/ --go-grpc_out=./api/ api/pb/minimax.proto"
...
(3) In the root directory of this project, enter "protoc -I ./api/pb/ --go_out=./api/pb ./api/pb/minimax.proto"
